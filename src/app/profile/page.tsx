      ...
      <section className="mb-10">
        <motion.div className="flex flex-col text-center items-center justify-center">
          ...
          <div className="text-center max-w-2xl px-4">
            ...
            >
              As a full-stack developer, I navigate seamlessly between front-end
              and back-end environments, utilizing a blend of technologies like{" "}
              <strong>Next.js</strong>, <strong>Angular</strong>, and{" "}
              <strong>TypeScript</strong> to create responsive, efficient
              applications. I bring ideas to life with{" "}
              ...
              approach every project as a unique challenge, with an eye for both
              functionality and design, ensuring that each experience is as
              engaging as it is powerful. By leveraging my skills across the
              stack, I build software that stands out—secure, scalable, and
              crafted to make a meaningful impact.
            </motion.p>
          </div>
        </motion.div>
      </section>
